      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="Banish.jsp">Banish List</a></li>

          </ul>
          <ul class="nav nav-sidebar">
            <li><a href="Add-Banish.jsp">Add Banish List</a></li>
          </ul>
          <ul class="nav nav-sidebar">
            <li><a href="Delete-Banish.jsp">Delete Banish List</a></li>
          </ul>
          
        <ul class="nav nav-sidebar">
            <li class="active"><a href="Alert-Banish.jsp">Alert Banish List</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
           ...
           <tr>
                  <td><%=1001+i%></td>
                  <td><input type="text" style="border:0px;" readonly="true" size=10 name=<%="JudQQ" %> value='<%=jud.getBanishQQ() %>'></td>
                  <td><input type="text" style="border:0px;" size=15 name=<%="JudName"%> value='<%=jud.getBanishName() %>'></td>
                  <td><input type="text" style="border:0px;" size=10 name=<%="TS"%> value='<%=jud.getRemark() %>'></td>
