		...
		<div class="container-fluid">
			...
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li class><a href="Banish.jsp">Check Banish</a></li>

				</ul>
				<ul class="nav nav-sidebar">
					<li><a href="Add-Banish.jsp">Add Banish</a></li>
				</ul>
				<ul class="nav nav-sidebar">
					<li><a href="Delete-Banish.jsp">Delete Banish</a></li>
				</ul>

				<ul class="nav nav-sidebar">
					<li><a href="Alert-Banish.jsp">Alert Banish</a></li>
				</ul>
			</div>
				...
				<div class="table-responsive">
					<table class="table table-striped">
						...
						{if (request.getParameter("sel").equals("QQ")){
							ArrayList<Banish> list = BanishDao.getBanishsbyQQ(str);
							...
							{ArrayList<Banish> list = BanishDao.getBanishsbyName(str);
							if(list!=null&&list.size()>0)
				               {
					               for(int i=0;i<list.size();i++)
					               {
