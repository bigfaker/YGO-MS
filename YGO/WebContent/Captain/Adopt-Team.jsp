...
<link href="../Team/css/bootstrap.css" rel="stylesheet">
<link href="../Team/css/dashboard.css" rel="stylesheet">
<link href="../Team/css/dashboard.css" rel="stylesheet">
<link href="../Team/css/white.css" rel="stylesheet">
<link href="../Team/css/zclc2.css" rel="stylesheet">
<link href="../Team/css/zebra.css" rel="stylesheet">



<script src="../Team/js/ie-emulation-modes-warning.js"></script>
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"
				...
				<form action="ActionAdopt.jsp" method="post">
					<div class="security-right" style="margin: 50px 774px 0px 0px;">
						<div class="sr-t">
						<%TeamDAO TeamDao=new TeamDAO();
						String TS=(session.getAttribute("TeamSign")).toString();
						ArrayList<Team> list = TeamDao.getTeamsbyTS(TS);
							...
							<ul>
								<li>
									<div class="sb-info">
										...
										<div class="sbi-m">
											<span><input class="user-id" name="TN" type="text" value=<%=t.getTeamName() %>></span>
										</div>
								...
								<li>
									<div class="sb-info">
										...
										<div class="sbi-m">
											<span><input class="user-id" name="TS" readonly="true" type="text" value=<%=t.getTeamSign() %>></span>
										</div>
								...
								<li>
									<div class="sb-info">
										...
										<div class="sbi-m">
											<span><input class="user-id" name="CN" type="text" value=<%=t.getCaptainName() %>></span>
										</div>
								...
								<li>
									...
									<div class="sb-info">
										...
										<div class="sbi-m">
											<span><input class="user-id" name="CQQ" type="text" value=<%=t.getCaptainQQ()%>></span>
										</div>
									...
									<div class="sb-info">
										...
										<div class="sbi-m">
											<textarea name="Honor" id="" cols="30" rows="10"
												class="my-sign" ><%=t.getHonor() %></textarea>
										</div>
									</div>
								</li>
								<li>
									...
									<div class="sb-info" style="margin: 80px 0px 0px 0px;">
										...
										<div class="sbi-m">
											<span><input class="user-id" name="Score" type="text" value=<%=t.getHonorScore() %>></span>
										</div>
								...
								<li>
									<div class="sb-info">
										...
										<div class="sbi-m">
											...
											<span><input class="user-id" name="OP" type="text" value=<%=t.getOpened() %>></span>
											</ul>
										</div>
									</div>
								</li>
									...
									<div class="sb-info">
										...
										<div class="sbi-m">
											<textarea name="CL" id="" cols="30" rows="10"
												class="my-sign" ><%=t.getCleared() %></textarea>
										</div>
									</div>
								</li>
								</br>
								<li><input type="submit" id="Save" value="保存"
    ...
    ================================================== -->
								...
								<script src="../Team/js/bootstrap.js"></script>
								<script src="../Team/js/docs.js"></script>
								...
								<div data-original-title="Copy to clipboard" title=""
									...
									<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
										id="global-zeroclipboard-flash-bridge" height="100%"
										width="100%">
										<param name="movie"
								...
								<svg
									...
									<defs></defs>
									<text
										style="font-weight:bold;font-size:50pt;font-family:Arial, Helvetica, Open Sans, sans-serif;dominant-baseline:middle"
