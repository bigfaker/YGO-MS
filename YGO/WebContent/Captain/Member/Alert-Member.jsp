        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
              ...
              <thead>
                 <tr>
                  <th>No.</th>
                  <th><input type="text" style="border:0px;" readonly="true" size=10 name=<%="JudQQ" %> value='Member QQ'></th>
                  <th><input type="text" style="border:0px;" readonly="true" size=15 name=<%="JudQQ" %> value='Member Name'></th>
                  <th><input type="text" style="border:0px;" readonly="true" size=10 name=<%="JudQQ" %> value='Member Duty'></th>
                  <th><input type="text" style="border:0px;" readonly="true" size=10 name=<%="JudQQ" %> value='Team Name'></th>
                  <th><input type="text" style="border:0px;" readonly="true" size=10 name=<%="JudQQ" %> value='Team Sign'></th>
                  <th><input type="text" style="border:0px;" readonly="true" size=10 name=<%="JudQQ" %> value=JoinTime></th>
           ...
           <%
               ...
               ArrayList<Member> list = MemberDao.getMembersbyTS(TS);
           ...
           <tr>
                  ...
                  <td><input type="text" style="border:0px;" size=10 name=<%="TS"%> readonly="readonly" value='<%=TS %>'></td>
