    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li class="active"><a href="Add-Member.jsp">Add Member List</a></li>
          </ul>
          <ul class="nav nav-sidebar">
        ...
        <ul class="nav nav-sidebar">
            <li><a href="Alert-Member.jsp">Alert Member List</a></li>
          </ul>
        </div>
 ...
 <form action="ActionAdd.jsp" method=post role="form">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                <!-- 循环开始 -->
           <%
           String TN=(session.getAttribute("TeamName")).toString();
          ...
          %> 
                ...
                <tr >
                	...
                	<td><input type="text" size=15 name=TN readonly="readonly" value=<%=TN %>></td>
                	<td><input type="text" size=15 name=TS readonly="readonly" value=<%=TS %>></td>
                	<td><input type="text" onclick="new Calendar().show(this);" readonly="readonly" name=JD></td>
                </tr>
