	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-3 col-md-2 sidebar">
					<ul class="nav nav-sidebar">
						<li>
							<a href="Member.jsp">Member List</a>
						</li>

					</ul>
					<ul class="nav nav-sidebar">
						<li>
							<a href="Add-Member.jsp">Add Member List</a>
						</li>
					</ul>
					<ul class="nav nav-sidebar">
						<li class="active">
							<a href="Delete-Member.jsp">Delete Member List</a>
						</li>
					</ul>

					<ul class="nav nav-sidebar">
						<li>
							<a href="Alert-Member.jsp">Alert Member List</a>
						</li>
					</ul>
				</div>
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<div class="table-responsive">
						<form name="myForm" id="myForm" action="../../1313" method="post">
           ...
           %>   
                <tr>
                  <td><%=1001+i%></td>
                  <td><%=jud.getMemberQQ() %></td>
                  <td><%=jud.getMemberName() %></td>
                  <td><%=jud.getMemberDuty() %></td>
                  <td><%=jud.getTeamName() %></td>
                  <td><%=jud.getTeamSign() %></td>
                  <td><%=jud.getJoinTime() %>
                  <td style="margin:  0px 0px 0px 20px;"><input type="checkbox" onclick="toChkSon(this)" value="<%=jud.getMemberQQ() %>" id="user" name="user"></td>
                </tr>
