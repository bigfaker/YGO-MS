...
<!-- Bootstrap core CSS -->
<link href="../Judgment/bootstrap.css" rel="stylesheet">

<!-- Custom styles for this template -->
<link href="../Judgment/dashboard.css" rel="stylesheet">

<!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
<!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
<script src="../Judgment/ie-emulation-modes-warning.js"></script>
...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
            ...
            <li><a href="Judgment.jsp">Back</a></li>
    ...
    ================================================== -->
			...
			<script src="../Judgment/jquery.js"></script>
			<script src="../Judgment/bootstrap.js"></script>
			<script src="../Judgment/docs.js"></script>
