...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			...
			<div id="navbar" class="navbar-collapse collapse">
				...
				<form class="navbar-form navbar-right" action="Inquery-Member.jsp"
					method="post">
					...
					</select> <input class="form-control" type="text" name="seled"> <input
	...
	<div class="col-sm-3 col-md-2 sidebar">
		<ul class="nav nav-sidebar">
			<li class><a href="Member.jsp">Check Member</a></li>

		</ul>
		<ul class="nav nav-sidebar">
			<li><a href="Add-Member.jsp">Add Member</a></li>
		</ul>
		<ul class="nav nav-sidebar">
			<li><a href="Delete-Member.jsp">Delete Member</a></li>
		</ul>

		<ul class="nav nav-sidebar">
			<li><a href="Alert-Member.jsp">Alert Member</a></li>
		</ul>
	</div>
				...
				<tbody>
					...
					<%
						...
						if (str != null) {
							if (request.getParameter("sel").equals("QQ")) {
								ArrayList<Member> list = MemberDao.getMembersbyQQ(str);
					...
					<%
							...
							if (request.getParameter("sel").equals("Name")) {
								ArrayList<Member> list = MemberDao.getMembersbyName(str);
								if (list != null && list.size() > 0) {
									for (int i = 0; i < list.size(); i++) {
										Member jud = list.get(i);
					%>
					...
					<%
							...
							if (request.getParameter("sel").equals("TS")) {
								ArrayList<Member> list = MemberDao.getMembersbyTS(str);
								if (list != null && list.size() > 0) {
									for (int i = 0; i < list.size(); i++) {
										Member jud = list.get(i);
					%>
