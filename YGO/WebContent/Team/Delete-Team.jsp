	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				...
				<ul class="nav nav-sidebar">
					<li class="active"><a href="Delete-Team.jsp">Delete Team</a></li>
				</ul>

			</div>
			<form name="myForm" id="myForm" action="../1212" method="post">
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<table class="table table-striped">
						<thead>
							<tr>
								...
								<th>Captain QQ</th>
								<th width="10px"><input
									type="checkbox" name="cheMsgId" id="chkMsgId" onclick="doCheck(this)"></th>
               ...
               ArrayList<Team> list = TeamDao.getAllTeams();
           ...
           %>
							<tr>
								...
								<td><%=jud.getCaptainName()%></td>
								<td><%=jud.getCaptainQQ()%></td>
								<td style="margin: 0px 0px 0px 20px;"><input type="checkbox" onclick="toChkSon(this)" value="<%=jud.getTeamSign() %>" id="user" name="user"></td>
							</tr>
<%}} %>
