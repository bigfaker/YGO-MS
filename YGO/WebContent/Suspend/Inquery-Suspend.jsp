		...
		<div class="container-fluid">
			...
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li class><a href="Suspend.jsp">Check Suspend</a></li>

				</ul>
				<ul class="nav nav-sidebar">
					<li><a href="Add-Suspend.jsp">Add Suspend</a></li>
				</ul>
				<ul class="nav nav-sidebar">
					<li><a href="Delete-Suspend.jsp">Delete Suspend</a></li>
				</ul>

				<ul class="nav nav-sidebar">
					<li><a href="Alert-Suspend.jsp">Alert Suspend</a></li>
				</ul>
			</div>
				...
				<div class="table-responsive">
					<table class="table table-striped">
						...
						{if (request.getParameter("sel").equals("QQ")){
							ArrayList<Suspend> list = SuspendDao.getSuspendsbyQQ(str);
							...
							{ArrayList<Suspend> list = SuspendDao.getSuspendsbyName(str);
							if(list!=null&&list.size()>0)
				               {
					               for(int i=0;i<list.size();i++)
					               {
