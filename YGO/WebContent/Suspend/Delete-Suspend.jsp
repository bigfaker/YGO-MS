	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-3 col-md-2 sidebar">
					<ul class="nav nav-sidebar">
						<li>
							<a href="Suspend.jsp">Suspend List</a>
						</li>

					</ul>
					<ul class="nav nav-sidebar">
						<li>
							<a href="Add-Suspend.jsp">Add Suspend List</a>
						</li>
					</ul>
					<ul class="nav nav-sidebar">
						<li class="active">
							<a href="Delete-Suspend.jsp">Delete Suspend List</a>
						</li>
					</ul>

					<ul class="nav nav-sidebar">
						<li>
							<a href="Alert-Suspend.jsp">Alert Suspend List</a>
						</li>
					</ul>
				</div>
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<div class="table-responsive">
						<form name="myForm" id="myForm" action="../888" method="post">
						<table class="table table-striped">
							...
							<tbody>
							 <!-- 驱逐循环开始 -->
           <%
               SuspendDAO BanishDao = new SuspendDAO(); 
               ArrayList<Suspend> list = BanishDao.getAllSuspends();
           ...
           %>   
                <tr>
                  <td><%=1001+i%></td>
                  <td><%=jud.getSuspendQQ() %></td>
                  <td><%=jud.getSuspendName() %></td>
                  <td><%=jud.getRemark() %></td>
                  <td><%=jud.getDate() %></td>
                  <td style="margin:  0px 0px 0px 20px;"><input type="checkbox" onclick="toChkSon(this)" value="<%=jud.getSuspendQQ() %>" id="user" name="user"></td>
                </tr>
         ...
         <td></td>
            ...
            <input type="submit" value="Delete"  name="ifAll" id="ifAll")">
