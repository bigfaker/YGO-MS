    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="">Suspend List</a></li>
            <li><a href="../Banish/Banish.jsp">Banish List</a></li>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li><a href="Add-Suspend.jsp">Add Suspend List</a></li>
          </ul>
          <ul class="nav nav-sidebar">
            <li><a href="Delete-Suspend.jsp">Delete Suspend List</a></li>
          </ul>
          
        <ul class="nav nav-sidebar">
            <li class="active"><a href="Alert-Suspend.jsp">Alert Suspend List</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Suspend List</h2>
          <div class="table-responsive">
              <table class="table table-striped">
              <thead>
                 <tr>
                  <th><input type="text" style="border:0px;" readonly="true" size=15 value=No.></th>
                  <th><input type="text" style="border:0px;" readonly="true" size=15 value=SuspendQQ></th>
                  <th><input type="text" style="border:0px;" readonly="true" size=15 value=SuspendName></th>
                  <th><input type="text" style="border:0px;" readonly="true" size=15 value=Remark></th>
                  <th><input type="text" style="border:0px;" readonly="true" size=15 value="Deblocking Date"></th>
                  <th>Alert</th>
           ...
           <%
               ...
               ArrayList<Suspend> list = SuspendDao.getAllSuspends();
               if(list!=null&&list.size()>0)
               {
	               for(int i=0;i<list.size();i++)
	               {
	                  Suspend jud = list.get(i);
           %>
           <form action="ActionAlert.jsp" method="post"><table class="table table-striped">
           <tr>
                  <td><input type="text" style="border:0px;" readonly="true" size=15 value=<%=1001+i%>></td>
                  <td><input type="text" style="border:0px;" readonly="true" size=15 name=<%="JudQQ" %> value='<%=jud.getSuspendQQ() %>'></td>
                  <td><input type="text" style="border:0px;" size=15 name=<%="JudName"%> value='<%=jud.getSuspendName() %>'></td>
                  <td><input type="text" style="border:0px;" size=15 name=<%="TS"%> value='<%=jud.getRemark() %>'></td>
                  <td><input type="text" style="border:0px;" size=15 onclick="new Calendar().show(this);" readonly="readonly" name=<%="DT"%> value='<%=jud.getDate() %>'></td>
                  <td><input type="submit"  value="Alert"></td>                
