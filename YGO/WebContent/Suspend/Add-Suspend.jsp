    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li class="active"><a href="Add-Suspend.jsp">Add Suspend List</a></li>
          </ul>
          <ul class="nav nav-sidebar">
        ...
        <ul class="nav nav-sidebar">
            <li><a href="Alert-Suspend.jsp">Alert Suspend List</a></li>
          </ul>
        </div>
 ...
 <form action="ActionAdd.jsp" method=post role="form">
          ...
          %> 
                ...
                <tr >
                	...
                	<td><input type="text" size=15 name=TS></td>
                	<td><input type="text" onclick="new Calendar().show(this);" readonly="readonly" name=DT></td>
                </tr>
