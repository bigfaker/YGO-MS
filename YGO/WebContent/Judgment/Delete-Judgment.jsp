...
<%@ page import="servlet.UserDeleteServlet" %>
<%
...
<style type="text/css">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-3 col-md-2 sidebar">
					<ul class="nav nav-sidebar">
						<li>
							<a href="Judgment.jsp">Check Judgment</a>
						</li>

					</ul>
					<ul class="nav nav-sidebar">
						<li>
							<a href="Add-Judgment.jsp">Add Judgment</a>
						</li>
					</ul>
					<ul class="nav nav-sidebar">
						<li class="active">
							<a href="Delete-Judgment.jsp">Delete Judgment</a>
						</li>
					</ul>

					<ul class="nav nav-sidebar">
						<li>
							<a href="Alert-Judgment.jsp">Alert Judgment</a>
						</li>
					</ul>
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<form name="myForm" id="myForm" action="../666" method="post">
           ...
           %>   
                <tr>
                  ...
                  <td style="margin:  0px 0px 0px 20px;"><input type="checkbox" onclick="toChkSon(this)" value="<%=jud.getJudgmentQQ() %>" id="user" name="user"></td>
                </tr>
    ...
    ================================================== -->
	    ...
	    <text style="font-weight:bold;font-size:10pt;font-family:Arial, Helvetica, Open Sans, sans-serif;dominant-baseline:middle" y="10" x="0">200x200</text></svg>
	</body>
