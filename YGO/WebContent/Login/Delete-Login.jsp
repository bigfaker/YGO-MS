...
<style type="text/css">
	...
	<body>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <li><a href="../Login/Delete-Admin.jsp">Admin List</a></li>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<form name="myForm" id="myForm" action="../999" method="post">
           ...
           %>   
                <tr>
                  ...
                  <td style="margin:  0px 0px 0px 20px;"><input type="checkbox" onclick="toChkSon(this)" value="<%=jud.getCaptainQQ() %>" id="user" name="user"></td>
                </tr>
