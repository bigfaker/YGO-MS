		...
		<div class="container-fluid">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					<li class="active"><a href="">Login List</a></li>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				...
				<ul class="nav nav-sidebar">
					<li><a href="Add-Login.jsp">Add Account List</a></li>
				</ul>
				<ul class="nav nav-sidebar">
				...
				<ul class="nav nav-sidebar">
					<li class="active"><a href="Alert-Login.jsp">Alert Account
							List</a></li>
				</ul>
			</div>
            ...
            <h2 class="sub-header">Admin List</h2>
				<div class="table-responsive">
						...
						<thead>
							<tr>
								<th><input type="text" style="border: 0px;" readonly="true"
									size=10 name=<%="JudQQ"%> value=No.></th>
								<th><input type="text" style="border: 0px;" readonly="true"
									size=10 name=<%="JudQQ"%> value=Admin></th>
								<th><input type="text" style="border: 0px;" readonly="true"
									size=15 name=<%="JudQQ"%> value=password></th>
								<th><input type="text" style="border: 0px;" readonly="true"
									size=3 name=<%="JudQQ"%> value=Alert></th>
					...
					%>
					<form action="ActionAlert1.jsp" method="post">
						<table class="table table-striped">
							<tr>
								<td><input type="text" style="border: 0px;" readonly="true"
									size=10  value=<%=1001 + i%>></td>
								<td><input type="text" style="border: 0px;" readonly="true"
									size=10 name=<%="JudQQ"%> value='<%=jud.getAdmin()%>'></td>
								<td><input type="text" style="border: 0px;" size=15
									name=<%="JudName"%> value='<%=jud.getPassword()%>'></td>
