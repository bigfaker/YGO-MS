...
<html lang="en">
	...
	<head>
        ...
        <script src="js/fuction1.js"></script>
	</head>
...
<style type="text/css">
	...
	<body>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <li class="active"><a href="../Login/Delete-Admin.jsp">Admin List</a></li>
            <li><a href="../Login/Delete-Login.jsp">Login</a></li>
					</ul>
			...
			<div class="row">
				<div class="col-sm-3 col-md-2 sidebar">
					<ul class="nav nav-sidebar">
						<li>
							<a href="Login.jsp">Account List</a>
						</li>

					</ul>
					<ul class="nav nav-sidebar">
						<li>
							<a href="Add-Login.jsp">Add Account List</a>
						</li>
					</ul>
					<ul class="nav nav-sidebar">
						<li class="active">
							<a href="Delete-Login.jsp">Delete Account List</a>
						</li>
					</ul>

					<ul class="nav nav-sidebar">
						<li>
							<a href="Alert-Login.jsp">Alert Account List</a>
						</li>
					</ul>
				</div>
		...
		<form name="myForm" id="myForm" action="../1010" method="post">
           ...
           <%
               ...
               if(list1!=null&&list1.size()>0)
               {
	               ...
	               {
	                  Admin jud = list1.get(i);
           %>   
                <tr>
                  <td><%=1001+i%></td>
                  <td><%=jud.getAdmin() %></td>
                  <td><%=jud.getPassword() %></td>
                  <td style="margin:  0px 0px 0px 20px;"><input type="checkbox" onclick="toChkSon(this)" value="<%=jud.getAdmin() %>" id="user" name="user"></td>
                </tr>
